...
namespace Robotics.Mobile.Core.Bluetooth.LE
{
	public class Characteristic : ICharacteristic
	{
		...
		/// <summary>
		/// we also track this because of Android's weird API. the gatt callback is where
                              ...
                              GattCallback gattCallback)
        {
            ...
            if (_gattCallback != null)
            {
                ...
                _gattCallback.CharacteristicValueUpdated += (object sender, CharacteristicReadEventArgs e) =>
                {
                    ...
                    if (e.Characteristic.ID == ID)
                    {
                        ...
                        //_nativeCharacteristic = e.Characteristic;
		...
		public CharacteristicPropertyType Properties
        {
            get
            {
                return (CharacteristicPropertyType)(int)_nativeCharacteristic.Properties;
            }
        }
        ...
        public Task<ICharacteristic> ReadAsync()
        {
            ...
            _gatt.ReadCharacteristic(this._nativeCharacteristic);
