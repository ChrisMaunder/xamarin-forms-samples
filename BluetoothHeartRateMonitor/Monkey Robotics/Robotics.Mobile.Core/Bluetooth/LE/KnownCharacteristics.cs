...
namespace Robotics.Mobile.Core.Bluetooth.LE
{
    ...
    public static class KnownCharacteristics
    {
        ...
        public static void LoadItemsFromJson()
        {
            ...
            Assembly assembly = typeof(KnownCharacteristics).GetTypeInfo().Assembly;
            string items = ResourceLoader.GetEmbeddedResourceString(assembly, "KnownCharacteristics.json");
